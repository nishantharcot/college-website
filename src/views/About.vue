<template>
  <div class="about">
    <StartScreen pageHeading="ABOUT US" />
    ...
    aboutItems: [
      {
        ...
        content: [
          ...
          " London College of Technology is a Community employment and training support providers.",
      ...
      },
      {
        ...
        content: [
          ...
          "Learners at London College of Technology have at least one thing in common: they are all learning for success. The College is committed to promoting equality and valuing diversity, as we have students of all ages, backgrounds and beliefs.",
      ...
      },
      {
        ...
        content: [
          ...
          "The classrooms at LCT are modern, spacious, well lit and impressive with all the latest technology. You’ll feel warmth with our staff and tutors, who are all friendly and welcoming.",

          "London College of Technology makes sure that all students feel at home in the multi-cultural and multi-lingual atmosphere provided by the College.",
